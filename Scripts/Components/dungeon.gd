...
func _draw_log():
	if adventure_handler.combat_log.size() > 0:
		...
		if adventure_handler.combat_log[0].ressource_snapshot == null:
			adventure_handler.combat_log[0].ressource_snapshot = adventure_handler.combat_log[1].ressource_snapshot
